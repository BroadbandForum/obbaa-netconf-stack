...
public class BcTlsCallhomeClient extends TlsCallhomeClient{
    ...
    private static final Logger LOGGER = Logger.getLogger(BcTlsCallhomeClient.class);
   ...
   static {
    ...
    public static void setupTrustManager(Class klass, String trustStore, NetconfTransportOrder order) {
        ...
        try {
            List<X509Certificate> trustCerts = CertificateUtil.getX509Certificates(CertificateUtil
                    .getByteArrayCertificates(CertificateUtil.stripDelimiters(CertificateUtil.certificateStringsFromFile(new File(
