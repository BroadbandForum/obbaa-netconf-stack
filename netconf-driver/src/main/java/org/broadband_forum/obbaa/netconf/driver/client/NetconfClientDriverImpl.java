...
/**
 * NetconfClientDriverImpl implements NetconfClientDriver such that allows sending seamless netconf request as xml
 * messages.
 *
 * @author gnanavek
 */
public class NetconfClientDriverImpl implements NetconfClientDriver {
    ...
    @Override
    public String sendGetRequest(String getXmlRequest) throws InterruptedException, ExecutionException,
            NetconfMessageBuilderException {
        return sendGetRequest(getXmlRequest, null);
    }

    @Override
    public String sendGetRequest(String getXmlRequest, Long timeoutInMillis) throws InterruptedException,
            ExecutionException, NetconfMessageBuilderException {
        try {
    ...
    @Override
    public String sendGetConfigRequest(String getConfigXmlRequest, Long timeoutInMillis) throws InterruptedException,
            ExecutionException,
            NetconfMessageBuilderException {
        try {
    ...
    @Override
    public String sendEditConfigRequest(String editConfigXmlRequest, Long timeoutInMillis) throws
    ...
    @Override
    public String sendCopyConfigRequest(String copyConfigXmlRequest) throws NetconfMessageBuilderException,
            InterruptedException, ExecutionException {
        return sendCopyConfigRequest(copyConfigXmlRequest, null);
    }

    @Override
    public String sendCopyConfigRequest(String copyConfigXmlRequest, Long timeoutInMillis) throws
            NetconfMessageBuilderException, InterruptedException,
            ExecutionException {
        try {
    ...
    @Override
    public String sendRpcRequest(String rpcXmlRequest) throws NetconfMessageBuilderException, InterruptedException,
            ExecutionException {
        return sendRpcRequest(rpcXmlRequest, null);
    }

    @Override
    public String sendRpcRequest(String rpcXmlRequest, Long timeoutInMillis) throws NetconfMessageBuilderException,
            InterruptedException, ExecutionException {
        try {
    ...
    @Override
    public String sendLockRequest(String lockXmlRequest) throws InterruptedException, ExecutionException,
            NetconfMessageBuilderException {
        return sendLockRequest(lockXmlRequest, null);
    }

    @Override
    public String sendLockRequest(String lockXmlRequest, Long timeoutInMillis) throws InterruptedException,
            ExecutionException, NetconfMessageBuilderException {
        try {
    ...
    @Override
    public String sendUnLockRequest(String unLockXmlRequest, Long timeoutInMillis) throws InterruptedException,
            ExecutionException,
            NetconfMessageBuilderException {
        try {
    ...
    @Override
    public String sendCloseSessionRequest(String closeSessionXmlRequest) throws InterruptedException,
            ExecutionException, NetconfMessageBuilderException {
        return sendCloseSessionRequest(closeSessionXmlRequest, null);
    }

    @Override
    public String sendCloseSessionRequest(String closeSessionXmlRequest, Long timeoutInMillis) throws
            InterruptedException, ExecutionException,
            NetconfMessageBuilderException {
        try {
    ...
    @Override
    public String sendKillSessionRequest(String killSessionXmlRequest) throws InterruptedException,
            ExecutionException, NetconfMessageBuilderException {
        return sendKillSessionRequest(killSessionXmlRequest, null);
    }

    @Override
    public String sendKillSessionRequest(String killSessionXmlRequest, Long timeoutInMillis) throws
            InterruptedException, ExecutionException,
            NetconfMessageBuilderException {
        try {
    ...
    @Override
    public String sendCreateSubscriptionRequest(String createSubscriptionXmlRequest, NotificationListener
    ...
    @Override
    public String sendCreateSubscriptionRequest(String createSubscriptionXmlRequest, NotificationListener
            notificationListener, Long timeoutInMillis)
            throws InterruptedException, ExecutionException, NetconfMessageBuilderException {
        try {
            CreateSubscriptionRequest createSubscriptionRequest = (CreateSubscriptionRequest) getRequest
                    (createSubscriptionXmlRequest,
                    NetconfResources.CREATE_SUBSCRIPTION);
            if (timeoutInMillis != null) {
                createSubscriptionRequest.setReplyTimeout(timeoutInMillis);
            }
            NetConfResponse response = m_netconfClientSession.createSubscription(createSubscriptionRequest,
                    notificationListener).get();
    ...
    @Override
    public String sendRequest(String xmlRequest) throws InterruptedException, ExecutionException,
            NetconfMessageBuilderException {
        return sendRequest(xmlRequest, null);
    }

    @Override
    public String sendRequest(String xmlRequest, Long timeoutInMillis) throws InterruptedException,
            ExecutionException, NetconfMessageBuilderException {
    ...
    private String sendRequest(AbstractNetconfRequest request, Long timeoutInMillis) throws InterruptedException,
            ExecutionException,
            NetconfMessageBuilderException {
        NetConfResponse response = null;
        LOGGER.info(String.format("Before sending request: %s, client info: %s \n Is session %s opening: %s", request
                        .getMessageId(),
        ...
        if (response != null) {
            ...
            if (request instanceof KillSessionRequest || request instanceof CloseSessionRequest) {
                ...
                LOGGER.info(String.format("Response is null, is session %s opening: %s", m_netconfClientSession
                                .getSessionId(),
    ...
    private AbstractNetconfRequest getRequest(String request, String requestType) throws
            NetconfMessageBuilderException {
    ...
    private String createErrorResponse() throws InterruptedException, ExecutionException,
            NetconfMessageBuilderException {
