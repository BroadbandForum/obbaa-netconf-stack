...
/**
 * NetconfClientDriver provide xml stream level interface for sending netconf request as xml message and receiving
 * response as xml message
 *
 * @author gnanavek
 */
public interface NetconfClientDriver {
     ...
     * @throws NetconfMessageBuilderException
     */
    public String sendRpcRequest(String rpcXmlRequest) throws InterruptedException, ExecutionException,
            NetconfMessageBuilderException;
     ...
     * @throws NetconfMessageBuilderException
     */
    public String sendRpcRequest(String rpcXmlRequest, Long timeoutInMillis) throws InterruptedException,
            ExecutionException, NetconfMessageBuilderException;
     ...
     * @throws NetconfMessageBuilderException
     */
    public String sendRequest(String getRequest) throws InterruptedException, ExecutionException,
            NetconfMessageBuilderException;
     ...
     * @throws NetconfMessageBuilderException
     */
    public String sendRequest(String getRequest, Long timeoutInMillis) throws InterruptedException,
            ExecutionException, NetconfMessageBuilderException;
