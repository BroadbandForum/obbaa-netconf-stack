...
public class JukeboxConstants {
    ...
    public static final String ADMIN_LOCAL_NAME = "admin";
    public static final String ARTIST_COUNT_LOCAL_NAME = "artist-count";
    public static final String ALBUM_LOCAL_NAME = "album";
    public static final String ALBUM_COUNT_LOCAL_NAME = "album-count";
    public static final String ALBUM_ORDERED_BY_USER_LOCAL_NAME = "album-ordered-by-user";
    public static final String SONG_LOCAL_NAME = "song";
    public static final String SONG_COUNT_LOCAL_NAME = "song-count";
    ...
    public static final QName SONG_COUNT_QNAME = QName.create(JB_NS, JB_REVISION, SONG_COUNT_LOCAL_NAME);
    ...
    public static final QName ADMIN_QNAME = QName.create(JB_NS, JB_REVISION, ADMIN_LOCAL_NAME);
    ...
    public static final String CATALOGUE_NUMBER = "catalogue-number";
    public static final QName CATALOGUE_NUMBER_QNAME = QName.create(JB_NS, JB_REVISION, CATALOGUE_NUMBER);
    ...
    public static final SchemaPath ALBUM_ORDERED_BY_USER_SCHEMA_PATH = new SchemaPathBuilder().withParent(ARTIST_SCHEMA_PATH).appendLocalName(ALBUM_ORDERED_BY_USER_LOCAL_NAME).build();
    ...
    public static final SchemaPath ADMIN_SCHEMA_PATH = new SchemaPathBuilder().withParent(ALBUM_SCHEMA_PATH).appendLocalName(ADMIN_LOCAL_NAME).build();
    ...
    public static final SchemaPath SONG_NAME_SCHEMA_PATH = new SchemaPathBuilder().withParent(SONG_SCHEMA_PATH).appendLocalName(NAME).build();
    ...
    public static final SchemaPath LOCATION_SCHEMA_PATH = new SchemaPathBuilder().withParent(SONG_SCHEMA_PATH).appendLocalName(LOCATION).build();
    public static final SchemaPath FORMAT_SCHEMA_PATH = new SchemaPathBuilder().withParent(SONG_SCHEMA_PATH).appendLocalName(FORMAT).build();
