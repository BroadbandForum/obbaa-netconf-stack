...
public class SchemaPathBuilderTest {
    ...
    public void testSimpleBuild() {
        ...
        assertEquals(SchemaPath.create(true, QName.create("http://example.com/ns/example-jukebox", "2015-02-27",
                "jukebox"),
    ...
    public void testBuildWithParent() {
        SchemaPathBuilder builder = new SchemaPathBuilder()
                ...
                .withRevision("2015-02-27").appendLocalName("jukebox").appendLocalName("library");
        SchemaPath schemaPath = builder.build();
        schemaPath = new SchemaPathBuilder().withNamespace("brand:new:namespace").withRevision("1988-03-27")
                .withParent(schemaPath).appendLocalName("song").build();

        assertEquals(SchemaPath.create(true, QName.create("http://example.com/ns/example-jukebox", "2015-02-27",
                "jukebox"),
                QName.create("http://example.com/ns/example-jukebox", "2015-02-27", "library"), QName.create
                        ("brand:new:namespace", "1988-03-27", "song")), schemaPath);
    }
    ...
    public void testFromString() throws SchemaPathBuilderException {
        ...
        assertEquals(artistSchemaPath, SchemaPathBuilder.fromString("(http://example" +
                ".com/ns/example-jukebox?revision=2015-02-27),jukebox,"
                + "library,artist"));
        ...
        assertEquals(pathWithMultipleNs, SchemaPathBuilder.fromString("(http://example" +
                ".com/ns/example-jukebox?revision=2015-02-27),jukebox,"
                + "library", "(urn:another:namespace?revision=2016-02-27)anotherLocalName, anotherLocalName2"));
        //Invalid cases
        try {
            SchemaPathBuilder.fromString("(http://example.com/ns/example-jukebox?revision=2015-02-27, jukebox," +
                    "library ,artist  ");
