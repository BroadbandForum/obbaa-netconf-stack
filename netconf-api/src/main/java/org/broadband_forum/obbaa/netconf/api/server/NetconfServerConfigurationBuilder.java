...
/**
 * A builder class to build a netconf server configuration. The following example shows how to build a SSH based
 ...
 *             .setAuthenticationHandler(new UTAuthHandler()).setNetconfServerMessageListener(new
 *             UTServerMessageListener())
...
public class NetconfServerConfigurationBuilder {
    ...
    public NetconfServerConfiguration build() throws NetconfConfigurationBuilderException {
        validate();
        NetconfServerConfiguration config = new NetconfServerConfiguration(m_netconfTransport, m_caps,
                m_capabilityProvider,
                m_netconfServerMessageListener, m_serverMessageHandler, m_authenticationHandler,
                m_connectionIdleTimeOutMillis,
    ...
    public static NetconfServerConfigurationBuilder createDefaultNcServerBuilder(int portId)
            throws UnknownHostException, NetconfConfigurationBuilderException {
        return createDefaultNcServerBuilder(new InetSocketAddress(InetAddress.getLocalHost(), portId));
    }

    public static NetconfServerConfigurationBuilder createDefaultNcServerBuilder(InetSocketAddress defaultServerSocketAddress)
            throws NetconfConfigurationBuilderException {
    ...
    private void validate() throws NetconfConfigurationBuilderException {
        ...
        boolean isCHTlsTransport = m_netconfTransport.getTranportProtocol().equals(NetconfTransportProtocol
                .REVERSE_TLS.name());
    ...
    /**
     * The type of transport to be used. See {@link NetconfTransportProtocol} to find out the currently supported
     * transport types.
     *
     ...
     * @return modified {@link NetconfServerConfigurationBuilder} instance.
     */
    public NetconfServerConfigurationBuilder setNetconfServerMessageListener(NetconfServerMessageListener
     ...
     * @return modified {@link NetconfServerConfigurationBuilder} instance.
     */
    public NetconfServerConfigurationBuilder setAuthenticationHandler(NetconfServerAuthenticationHandler
    ...
    /**
     * This is a way for clients to supply a AsynchronousChannelGroup, which is used to server requests on the SSH
     * channel.
     *
