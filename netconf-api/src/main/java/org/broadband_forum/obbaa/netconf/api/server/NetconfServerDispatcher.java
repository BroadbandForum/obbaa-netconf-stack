...
public interface NetconfServerDispatcher {
    ...
    /**
     * Use this method to run a netconf server. The following example shows how to run to a SSH based netconf server
     * with certain set of
     * configurations.
     * <p>
     * <pre>
     ...
     *                                                     .setServerSocketAddress(new InetSocketAddress(InetAddress
     ...
     *                                                         handler for client auth
     *                                                         .setNetconfServerMessageListener(new
     *                                                         UTServerMessageListener()) // listener for client
     *                                                         messages
     *                                                         .setConnectionIdleTimeoutMillis(CONNECTIONTIMEOUT)
     *                                                         .setCapabilities(serverCaps)
     *                                                         .setTransport(NetconfTransportFactory
     *                                                         .makeNetconfTransport(transportOder));
     *
