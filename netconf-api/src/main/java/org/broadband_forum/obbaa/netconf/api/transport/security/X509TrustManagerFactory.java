...
public class X509TrustManagerFactory extends TrustManagerFactory {
    ...
    public X509TrustManagerFactory(X509TrustManagerFactorySpi trustServiceProvider) {
        super(trustServiceProvider, PROVIDER, TrustManagerFactory.getDefaultAlgorithm());
    }
