...
public class PeerCertificateException extends CertificateException {
    ...
    private X509Certificate[] m_untrustedCertificates;

    public PeerCertificateException(Throwable cause, X509Certificate[] certificates) {
        super(cause.getMessage(), cause);
        m_untrustedCertificates = certificates;
    }

    public X509Certificate[] getPeerCertificates() {
        return m_untrustedCertificates;
    }
