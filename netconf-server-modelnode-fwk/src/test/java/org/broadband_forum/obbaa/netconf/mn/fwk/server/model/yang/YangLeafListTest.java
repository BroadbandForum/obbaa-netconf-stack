...
public class YangLeafListTest extends AbstractYangValidationTestSetup{
	...
	private void setDataStoreAndModel(String datastore, String dataXmlPath) throws ModelNodeInitException, SchemaBuildException {
        ...
        DsmJukeboxSubsystem subSystem = new DsmJukeboxSubsystem(m_runningModelNodeDsm,"http://example.com/ns/example-jukebox-with-singer");
		...
		m_jukeboxModelNode = YangUtils.createInMemoryModelNode(YangLeafListTest.class.getResource(LEAFLIST_MODEL_YANG).getPath(), subSystem, m_modelNodeHelperRegistry,
