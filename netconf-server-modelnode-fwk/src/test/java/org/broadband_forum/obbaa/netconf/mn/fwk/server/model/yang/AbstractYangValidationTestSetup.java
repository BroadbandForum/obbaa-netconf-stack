...
import org.broadband_forum.obbaa.netconf.mn.fwk.server.model.service.ModelServiceDeployerTest;
...
public abstract class AbstractYangValidationTestSetup extends AbstractValidationTestSetup {
    ...
    public void setUpForChoiceCase() throws SchemaBuildException, ModelNodeInitException {
        ...
        m_schemaRegistry = new SchemaRegistryImpl(getYangFilePath(YANG_MOULE_REL_PATH), new NoLockService());
        ...
        m_rootModelNode = new RootModelNodeAggregatorImpl(m_schemaRegistry, modelNodeHelperRegistry, modelNodeDsm,
                m_subSystemRegistry)
                .addModelServiceRoot(ModelServiceDeployerTest.COMPONENT_ID, m_runningModel);
    ...
    protected void createRootModelNode() {
        ...
        try {
            m_rootModelNode = new RootModelNodeAggregatorImpl(m_schemaRegistry, m_modelNodeHelperRegistry,
    ...
    protected ModelNodeWithAttributes getModelNodeWithAttrs() throws ModelNodeInitException {
        return YangUtils.createInMemoryModelNode(YANG_PATH, new LocalSubSystem(), m_modelNodeHelperRegistry,
                m_subSystemRegistry,
