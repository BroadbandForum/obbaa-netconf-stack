...
import static org.broadband_forum.obbaa.netconf.mn.fwk.server.model.support.constraints.validation.util.DataStoreValidationUtil
        .NC_ENABLE_POST_EDIT_DS_VALIDATION_SUPPORT;
...
public abstract class AbstractValidationTestSetup {
    ...
    protected void verifyGet(NetconfServer server, NetconfClientInfo clientInfo, String expectedOutput) throws
    ...
    protected void verifyGet(NetconfServer server, NetconfClientInfo clientInfo, String requestFilterString, String
            expectedOutput) throws SAXException, IOException {
        GetRequest request = new GetRequest();
    ...
    protected NetConfResponse editConfig(NetconfServer server, NetconfClientInfo clientInfo, String requestXml1,
                                         boolean assertTrue) {
        RequestScope.resetScope();
        EditConfigRequest request1 = AbstractDataStoreValidatorTest.createRequestFromString(requestXml1);
