...
public class GetWithStateFilterTest {
    ...
    public void setup() throws SchemaBuildException, AnnotationAnalysisException, ModelNodeFactoryException {
        ...
        m_annotationBasedDSM = TestTxUtils.getTxDecoratedDSM(m_persistenceManagerUtil, new AnnotationBasedModelNodeDataStoreManager(m_persistenceManagerUtil,
        ...
        SchemaRegistryTraverser traverser = new SchemaRegistryTraverser(COMPONENT_ID,
                ...
                m_schemaRegistry.getModule(MODULE_NAME, Revision.of(JB_REVISION)).orElse(null));
        traverser.traverse();
    ...
    private void updateEntityRegistry() throws AnnotationAnalysisException {
        ...
        EntityRegistryBuilder.updateEntityRegistry(COMPONENT_ID, classes, m_entityRegistry, m_schemaRegistry, null, m_modelNodeDSMRegistry);
