...
public class ListSchemaNodeTypeValidatorTest {
    ...
    public void setUp() throws SchemaBuildException {
        ...
        m_editConfigValidator = new RpcRequestConstraintParser(m_schemaRegistry, m_modelNodeDsm, mock
                (DSExpressionValidator.class));
    }
    ...
    public void testValidate() throws NetconfMessageBuilderException {
        try {
            ...
            assertEquals("name", rpcError.getErrorInfo().getElementsByTagName(NetconfRpcErrorInfo.BadElement.value())
                    .item(0)
                    .getTextContent());
        }
        ...
        try {
            ...
            assertTrue(rpcError.getErrorInfo().getElementsByTagName(NetconfRpcErrorInfo.BadElement.value()) != null);
            assertEquals("device-id", rpcError.getErrorInfo().getElementsByTagName(NetconfRpcErrorInfo.BadElement
                    .value()).item(0)
                    .getTextContent());
        }
        ...
        try {
            ...
            NetconfRpcError rpcError = e.getRpcError();
            assertEquals(NetconfRpcErrorTag.MISSING_ELEMENT, rpcError.getErrorTag());
            String errorMessage = String.format(NetconfRpcErrorMessages.EXPECTED_KEYS_IS_MISSING, "[dpu-hwver-type, " +
                    "dpu-tag]");
            assertEquals(errorMessage, rpcError.getErrorMessage());
    ...
    public void testListKeysOfCorrectOrder() throws NetconfMessageBuilderException {
        try {
            ...
            NetconfRpcError rpcError = e.getRpcError();
            assertEquals(NetconfRpcErrorTag.MISSING_ELEMENT, rpcError.getErrorTag());
            String errorMessage = String.format(NetconfRpcErrorMessages.EXPECTED_KEYS_IS_MISPLACED, "[dpu-hwver-type," +
                    " dpu-tag]");
            assertEquals(errorMessage, rpcError.getErrorMessage());
            assertEquals("/pma:pma/pma:pma-swmgmt/pma:pma-svc/pma:pma-swver-ctl-dpu[pma:dpu-tag='1.0'][pma:dpu-hwver" +
                    "-type='G.FAST']", rpcError.getErrorPath());
            NodeList badElement = rpcError.getErrorInfo().getElementsByTagName(NetconfRpcErrorInfo.BadElement.value());
            assertTrue(badElement != null);
    ...
    public void testValidateInsertAttributes() throws NetconfMessageBuilderException {
        ...
        EditConfigRequest invalidEditConfigRequest = DocumentToPojoTransformer.getEditConfig(DocumentUtils
                .loadXmlDocument(ListSchemaNodeTypeValidatorTest.class
                        .getResourceAsStream("/yangSchemaValidationTest/rpcpayloadvalidatortest/requests/editconfigs" +
                                "/invalid-editconfig-request15.xml")));
        try {
        ...
        invalidEditConfigRequest = DocumentToPojoTransformer.getEditConfig(DocumentUtils
                .loadXmlDocument(ListSchemaNodeTypeValidatorTest.class
                        .getResourceAsStream("/yangSchemaValidationTest/rpcpayloadvalidatortest/requests/editconfigs" +
                                "/invalid-editconfig-request16.xml")));
        try {
        ...
        invalidEditConfigRequest = DocumentToPojoTransformer.getEditConfig(DocumentUtils
                .loadXmlDocument(ListSchemaNodeTypeValidatorTest.class
                        .getResourceAsStream("/yangSchemaValidationTest/rpcpayloadvalidatortest/requests/editconfigs" +
                                "/invalid-editconfig-request17.xml")));
        try {
        ...
        invalidEditConfigRequest = DocumentToPojoTransformer.getEditConfig(DocumentUtils
                .loadXmlDocument(ListSchemaNodeTypeValidatorTest.class
                        .getResourceAsStream("/yangSchemaValidationTest/rpcpayloadvalidatortest/requests/editconfigs" +
                                "/invalid-editconfig-request18.xml")));
        try {
        ...
        invalidEditConfigRequest = DocumentToPojoTransformer.getEditConfig(DocumentUtils
                .loadXmlDocument(ListSchemaNodeTypeValidatorTest.class
                        .getResourceAsStream("/yangSchemaValidationTest/rpcpayloadvalidatortest/requests/editconfigs" +
                                "/invalid-editconfig-request19.xml")));
        try {
        ...
        invalidEditConfigRequest = DocumentToPojoTransformer.getEditConfig(DocumentUtils
                .loadXmlDocument(ListSchemaNodeTypeValidatorTest.class
                        .getResourceAsStream("/yangSchemaValidationTest/rpcpayloadvalidatortest/requests/editconfigs" +
                                "/invalid-editconfig-request20.xml")));
        try {
            ...
            LOGGER.error(e);
            NetconfRpcError rpcError = e.getRpcError();
            assertEquals("There is an unknown key 'ex:key1' in key '[ex:key1='1']' attribute", rpcError
                    .getErrorMessage());
            assertEquals(NetconfRpcErrorTag.BAD_ATTRIBUTE, rpcError.getErrorTag());
        }
        ...
        invalidEditConfigRequest = DocumentToPojoTransformer.getEditConfig(DocumentUtils
                .loadXmlDocument(ListSchemaNodeTypeValidatorTest.class
                        .getResourceAsStream("/yangSchemaValidationTest/rpcpayloadvalidatortest/requests/editconfigs" +
                                "/invalid-editconfig-request21.xml")));
        try {
            m_editConfigValidator.validate(invalidEditConfigRequest, RequestType.EDIT_CONFIG);
            fail("validation should have thrown an exception for request: " + invalidEditConfigRequest
                    .requestToString());
            ...
            LOGGER.error(e);
            NetconfRpcError rpcError = e.getRpcError();
            assertEquals("There is a duplicated key 'key1' in key '[key1='1'][key1='2']' attribute", rpcError
                    .getErrorMessage());
            assertEquals(NetconfRpcErrorTag.BAD_ATTRIBUTE, rpcError.getErrorTag());
        }
        ...
        invalidEditConfigRequest = DocumentToPojoTransformer.getEditConfig(DocumentUtils
                .loadXmlDocument(ListSchemaNodeTypeValidatorTest.class
                        .getResourceAsStream("/yangSchemaValidationTest/rpcpayloadvalidatortest/requests/editconfigs" +
                                "/invalid-editconfig-request22.xml")));
        try {
            m_editConfigValidator.validate(invalidEditConfigRequest, RequestType.EDIT_CONFIG);
            fail("validation should have thrown an exception for request: " + invalidEditConfigRequest
                    .requestToString());
        ...
        invalidEditConfigRequest = DocumentToPojoTransformer.getEditConfig(DocumentUtils
                .loadXmlDocument(ListSchemaNodeTypeValidatorTest.class
                        .getResourceAsStream("/yangSchemaValidationTest/rpcpayloadvalidatortest/requests/editconfigs" +
                                "/invalid-editconfig-request23.xml")));
        try {
            m_editConfigValidator.validate(invalidEditConfigRequest, RequestType.EDIT_CONFIG);
            fail("validation should have thrown an exception for request: " + invalidEditConfigRequest
                    .requestToString());
