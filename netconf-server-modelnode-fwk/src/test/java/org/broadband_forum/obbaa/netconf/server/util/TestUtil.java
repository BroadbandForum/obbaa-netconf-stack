...
public class TestUtil {
    ...
    public static Jukebox createJukeBoxModel(ModelNodeHelperRegistry modelNodeHelperRegistry, SubSystemRegistry subSystemRegistry,
        ...
        try {
            ...
            jukebox.setLibrary(new Library(jukebox, jukebox.getModelNodeId(), modelNodeHelperRegistry, subSystemRegistry, schemaRegistry));
            Artist lenny;
    ...
    public static Jukebox createEmptyJukeBox(ModelNodeHelperRegistry modelNodeHelperRegistry, SubSystemRegistry subSystemRegistry, SchemaRegistry schemaRegistry) {
        registerClasses(modelNodeHelperRegistry);
        Jukebox jukebox = new Jukebox(null, new ModelNodeId(), modelNodeHelperRegistry, subSystemRegistry, schemaRegistry);
        return jukebox;
    }
	public static Jukebox createJukeBoxModelWithYear(ModelNodeHelperRegistry modelNodeHelperRegistry, SubSystemRegistry subSystemRegistry,
                                                     SchemaRegistry schemaRegistry) {
	    registerClasses(modelNodeHelperRegistry);
		Jukebox jukebox = new Jukebox(null, new ModelNodeId(), modelNodeHelperRegistry, subSystemRegistry, schemaRegistry);

		try {
		    jukebox.setLibrary(new Library(jukebox, new ModelNodeId(), modelNodeHelperRegistry, subSystemRegistry, schemaRegistry));
            ...
            lenny.addAlbum("Circus").setYear(1995).addSong("Rock and roll is dead").addSong("Circus").addSong("Beyond the 7th Sky");
		} catch (EditException e) {
            LOGGER.error("Error while creating model",e);
        }
		return jukebox;
	...
	public static Jukebox createJukeBoxWithEmptyLibrary(ModelNodeHelperRegistry modelNodeHelperRegistry, SubSystemRegistry subSystemRegistry, SchemaRegistry schemaRegistry) {
        registerClasses(modelNodeHelperRegistry);
        Jukebox jukebox = new Jukebox(null, new ModelNodeId(), modelNodeHelperRegistry, subSystemRegistry, schemaRegistry);
        try {
            jukebox.setLibrary(new Library(jukebox, new ModelNodeId(), modelNodeHelperRegistry, subSystemRegistry, schemaRegistry));
	...
	public static void registerClasses(ModelNodeHelperRegistry modelNodeHelperRegistry) {
	    try {
			...
			ModelNodeRegistrar.registerAnnotationModelNodeClass(jukebox, Jukebox.JUKEBOX_SCHEMA_PATH, Jukebox.class, modelNodeHelperRegistry);
            ModelNodeRegistrar.registerAnnotationModelNodeClass(jukebox, Library.LIBRARY_SCHEMA_PATH, Library.class, modelNodeHelperRegistry);
            ModelNodeRegistrar.registerAnnotationModelNodeClass(jukebox, Artist.ARTIST_SCHEMA_PATH, Artist.class, modelNodeHelperRegistry);
            ModelNodeRegistrar.registerAnnotationModelNodeClass(jukebox, Album.ALBUM_SCHEMA_PATH, Album.class, modelNodeHelperRegistry);
            ModelNodeRegistrar.registerAnnotationModelNodeClass(jukebox, AlbumImage.ALBUMIMAGE_SCHEMA_PATH, AlbumImage.class, modelNodeHelperRegistry);
            ModelNodeRegistrar.registerAnnotationModelNodeClass(jukebox, Song.SONG_SCHEMA_PATH, Song.class, modelNodeHelperRegistry);
	...
	private static void registerModelNodeFactories(ModelNodeHelperRegistry modelNodeHelperRegistry) {
        try {
            ModelNodeRegistrar.registerModelNodeFactory("AbstractModelNodeFactory", new AbstractModelNodeFactory(), modelNodeHelperRegistry);
