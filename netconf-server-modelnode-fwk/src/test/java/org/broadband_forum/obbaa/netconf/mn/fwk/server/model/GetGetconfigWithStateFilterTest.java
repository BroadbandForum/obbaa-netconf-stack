...
public class GetGetconfigWithStateFilterTest {
    ...
    public void initServer() throws SchemaBuildException {
        ...
        m_subSystemRegistry.register(componentId, new SchemaPathBuilder().withParent(Library.LIBRARY_SCHEMA_PATH).appendLocalName("song-count").build(), librarySystem);
    ...
    public void testGetWithStateFilter() throws SAXException, IOException {
        verifyGet(m_server, "/album-state-filter1.xml", "/get-with-album-state-filter1-response.xml", "1");
        verifyGet(m_server, "/album-state-filter2.xml", "/get-with-album-state-filter2-response.xml", "1");
        verifyGet(m_server, "/album-state-filter4.xml", "/get-with-album-state-filter4-response.xml", "1");
    }

    @Test
    public void testGetWithStateSubtreeFilter() throws SAXException, IOException {
        verifyGet(m_server, "/album-state-filter6.xml", "/get-with-album-state-filter6-response.xml", "1");
    }

    @Test
    public void testGetConfigWithStateFilter() throws SAXException, IOException {
        verifyGetConfig(m_server, "/album-state-filter1.xml", "/empty-response.xml", "1");
        verifyGetConfig(m_server, "/album-state-filter3.xml", "/empty-response.xml", "1");
    }
