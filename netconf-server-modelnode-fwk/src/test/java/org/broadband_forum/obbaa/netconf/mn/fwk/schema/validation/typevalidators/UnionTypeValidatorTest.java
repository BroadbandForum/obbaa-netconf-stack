...
public class UnionTypeValidatorTest extends AbstractTypeValidatorTest {
    ...
    public void testInValidUnion() throws NetconfMessageBuilderException {
        testFail("unionvalidator/invalid-union-1.xml",
                "The argument is out of bounds <min, 0> | The argument is out of bounds <10, 100> | The argument is " +
                        "out of bounds <120, max> or Value \"9\" is an invalid value! Expected values: [union]",
                "/validation:validation/validation:type-validation[validation:id='1']/validation:union-type",
        ...
        testFail("unionvalidator/invalid-union-2.xml",
                "The argument is out of bounds <min, 0> | The argument is out of bounds <10, 100> | The argument is " +
                        "out of bounds <120, max> or Value \"128\" is an invalid value! Expected values: [union]",
                "/validation:validation/validation:type-validation[validation:id='1']/validation:union-type",
                "range-out-of-specified-bounds | range-out-of-specified-bounds | range-out-of-specified-bounds");

        testFail("unionvalidator/invalid-union-3.xml",
                "The argument is out of bounds <min, 0> | The argument is out of bounds <10, 100> | The argument is " +
                        "out of bounds <120, max> or Value \"abc\" is an invalid value! Expected values: [union]",
                "/validation:validation/validation:type-validation[validation:id='1']/validation:union-type",
                "range-out-of-specified-bounds | range-out-of-specified-bounds | range-out-of-specified-bounds");

        testFail("unionvalidator/invalid-union-4.xml",
                "The argument is out of bounds <min, 0> | The argument is out of bounds <10, 100> | The argument is " +
                        "out of bounds <120, max> or Value \"\" is an invalid value! Expected values: [union]",
                "/validation:validation/validation:type-validation[validation:id='1']/validation:union-type",
                "range-out-of-specified-bounds | range-out-of-specified-bounds | range-out-of-specified-bounds");
    }
    ...
    public void testCustomUnion() throws NetconfMessageBuilderException {
        ...
        testCustomFail(formRequestString(invalidCustomReq1),
                ...
                "/validation:validation/validation:type-validation[validation:id='1']/validation:custom-union-type",
