...
public class RootModelNodeAggregatorImplTest {
    ...
    private static final String TOASTER_FILTER_MATCH = "/rootmodelnodetest/toaster_filter_match.xml";
    private static final String TOASTER_FILTER_MATCH_RESPONSE = "/rootmodelnodetest/toaster_filter_match_response.xml";

    private static final String JUKEBOX_AND_TOASTER_FILTER_RESPONSE = "/rootmodelnodetest/jukebox_and_toaster_filter_response.xml";
    ...
    private static final String FULL_GET_CONFIG_RESPONSE_AFTER_DO_COPY_CONFIG = "/rootmodelnodetest/full_get_config_response_after_copy_config_tester.xml";

    private static final String EDIT_ON_JUKEBOX = "/rootmodelnodetest/edit_on_jukebox.xml";
    private static final String RESPONSE_AFTER_EDIT_ON_JUKEBOX = "/rootmodelnodetest/response_after_edit_on_jukebox.xml";

    private static final String EDIT_ON_JUKEBOX_WITH_NS_PREFIX = "/rootmodelnodetest/edit_on_jukebox_with_ns_prefix.xml";
    private static final String RESPONSE_AFTER_EDIT_ON_JUKEBOX_WITH_NS_PREFIX = "/rootmodelnodetest/response_after_edit_on_jukebox_with_ns_prefix.xml";
    ...
    private static final SchemaPath WA_CONFIG_SCHEMAPATH = SchemaPath.create(true, QName.create(WA_NS, WA_REVISION, WA_CONFIG_LOCALNAME));
    private static final String WA_CITY_LOCALNAME = "city";
    private static final SchemaPath WA_CITY_SCHEMAPATH = SchemaPath.create(true, QName.create(WA_NS, WA_REVISION, WA_CITY_LOCALNAME));
    public static final String ROOT_CONTAINER = "root-container";
    public static final SchemaPath WA_ROOT_CONTAINER_SCHEMAPATH = SchemaPath.create(true, QName.create(WA_NS, WA_REVISION, ROOT_CONTAINER));
    ...
    private ChildContainerHelper m_jukeBoxHelper;
    private ChildContainerHelper m_toasterHelper;
    private ContainerSchemaNode m_jukeboxSchemaNode;
    ...
    public void setUp() throws Exception {
        ...
        m_jukeboxSchemaNode = (ContainerSchemaNode) m_schemaRegistry.getDataSchemaNode(JukeboxConstants.JUKEBOX_SCHEMA_PATH);
        ChildContainerHelper jukeBoxHelper = new RootEntityContainerModelNodeHelper(m_jukeboxSchemaNode,
        ...
        m_toasterSchemaNode = (ContainerSchemaNode) m_schemaRegistry.getDataSchemaNode(ToasterConstants.TOASTER_SCHEMA_PATH);
        ChildContainerHelper toasterHelper = new RootEntityContainerModelNodeHelper(m_toasterSchemaNode,
                m_modelNodeHelperRegistry, m_subSystemRegistry, m_schemaRegistry, m_runningDsm);
    ...
    @Test
    public void testImprovedGetWithNoFilter() throws IOException, SAXException, ModelNodeGetException {
        addSpyHelpers();
        verifyGet(m_server, (NetconfFilter) null, FULL_GET_RESPONSE, "1");
        verify(m_jukeBoxHelper).getValue(null);
        verify(m_toasterHelper).getValue(null);
    }

    @Test
    public void testImprovedGetWithInvalidFilter() throws IOException, SAXException, ModelNodeGetException {
        addSpyHelpers();
        verifyGet(m_server, INVALID_FILTER, INVALID_FILTER_RESPONSE, "1");
        verify(m_jukeBoxHelper, never()).getValue(null);
        verify(m_toasterHelper, never()).getValue(null);
    }

    @Test
    public void testImprovedGetJukeboxAlone() throws IOException, SAXException, ModelNodeGetException {
        addSpyHelpers();
    ...
    @Test
    public void testImprovedGetToasterAlone() throws IOException, SAXException, ModelNodeGetException {
        addSpyHelpers();
    ...
    @Test
    public void testImprovedGetToasterAloneMatch() throws IOException, SAXException, ModelNodeGetException {
        addSpyHelpers();
        verifyGet(m_server, TOASTER_FILTER_MATCH, TOASTER_FILTER_MATCH_RESPONSE, "1");
        verify(m_jukeBoxHelper, never()).getValue(null);
        verify(m_toasterHelper).getValue(null);
    }

    @Test
    public void testImprovedGetBothJukeBoxAndToaster() throws IOException, SAXException, ModelNodeGetException {
        addSpyHelpers();
    ...
    @Test
    public void testEditOnJukeboxAlone() throws EditConfigException, IOException, SAXException, ModelNodeGetException {
        addSpyHelpers();
        ...
        //make sure only jukebox helper is called
        verify(m_jukeBoxHelper).getValue(null);
        verify(m_toasterHelper, never()).getValue(null);
    ...
    public void testEditOnJukeboxAloneWithNsPrefix() throws EditConfigException, IOException, SAXException {
        EditConfigRequest request = new EditConfigRequest()
                ...
                .setTestOption(EditConfigTestOptions.SET)
                .setErrorOption(EditConfigErrorOptions.STOP_ON_ERROR)
                .setConfigElement(new EditConfigElement().addConfigElementContent(loadAsXml(EDIT_ON_JUKEBOX_WITH_NS_PREFIX)));
        request.setMessageId("1");
        NetConfResponse response = new NetConfResponse().setMessageId("1");
        m_server.onEditConfig(new NetconfClientInfo("unit-test", 1), request, response);
        // assert Ok response
    ...
    @Test
    public void testEditOnToasterAlone() throws EditConfigException, IOException, SAXException, ModelNodeGetException {
        addSpyHelpers();
        EditConfigRequest request = new EditConfigRequest()
                .setTargetRunning()
                .setTestOption(EditConfigTestOptions.SET)
        ...
        NetConfResponse response = new NetConfResponse().setMessageId("1");
        m_server.onEditConfig(new NetconfClientInfo("unit-test", 1), request, response);
        //make sure only toaster helper is called
        verify(m_jukeBoxHelper, never()).getValue(null);
        verify(m_toasterHelper).getValue(null);
        // assert Ok response
        assertXMLEquals("/ok-response.xml", response);
    ...
    public void testRootNodeCreate() throws Exception {
        m_schemaRegistry.loadSchemaContext("weather-app", Arrays.asList(TestUtil.getByteSource("/rootmodelnodetest/weather-app.yang")), Collections.emptySet(), Collections.emptyMap());
        addWaRootHelpers();
        ...
        EditConfigRequest request = new EditConfigRequest()
                ...
                .setTestOption(EditConfigTestOptions.SET)
                .setErrorOption(EditConfigErrorOptions.STOP_ON_ERROR)
                .setConfigElement(new EditConfigElement().addConfigElementContent(loadAsXml(ROOT_CONFIG_CONTAINER_CREATE)));
        request.setMessageId("1");
        NetConfResponse response = new NetConfResponse().setMessageId("1");
        m_server.onEditConfig(new NetconfClientInfo("unit-test", 1), request, response);
        // do a get-config to be sure
        verifyGetConfig(m_server, "/rootmodelnodetest/root_config_container_filter.xml", RESPONSE_AFTER_ROOT_CONFIG_CONTAINER_CREATE, "1");
        ...
        m_server.onEditConfig(new NetconfClientInfo("unit-test", 1), request, response);
        // do a get-config to be sure
        verifyGetConfig(m_server, "/rootmodelnodetest/root_city_list_filter.xml", RESPONSE_AFTER_ROOT_CITY_LIST_CREATE, "1");

        request.setConfigElement(new EditConfigElement().addConfigElementContent(loadAsXml(ROOT_CITY_LIST_CREATE2)));
        response = new NetConfResponse().setMessageId("1");
        m_server.onEditConfig(new NetconfClientInfo("unit-test", 1), request, response);
        // do a get-config to be sure
        verifyGetConfig(m_server, "/rootmodelnodetest/root_city_list_filter.xml", RESPONSE_AFTER_ROOT_CITY_LIST_CREATE2, "1");
    ...
    public void testInvalidEdit3() throws IOException, SAXException {
        EditConfigRequest request = new EditConfigRequest()
                ...
                .setTestOption(EditConfigTestOptions.SET)
                .setErrorOption(EditConfigErrorOptions.ROLLBACK_ON_ERROR)
                .setConfigElement(new EditConfigElement().addConfigElementContent(loadAsXml(EDIT_ON_TOASTER)) //lets test rollback of the root model
    ...
    @Test
    public void testGetConfig1() throws IOException, SAXException, SchemaBuildException, ModelNodeFactoryException, ModelNodeInitException {
        m_schemaRegistry.loadSchemaContext("tester", Arrays.asList(TestUtil.getByteSource("/rootmodelnodetest/tester.yang")), Collections.emptySet(), Collections.emptyMap());
    ...
    @Test
    public void testGetReturnsNoEmptyStateRoot() throws IOException, SAXException, SchemaBuildException, ModelNodeFactoryException, ModelNodeInitException {
        m_schemaRegistry.loadSchemaContext("tester", Arrays.asList(TestUtil.getByteSource("/rootmodelnodetest/tester.yang")), Collections.emptySet(), Collections.emptyMap());
        String stateRootPath = getClass().getResource("/rootmodelnodetest/state-root.xml").getPath();
        String stateContainerPath = getClass().getResource("/rootmodelnodetest/state-container.xml").getPath();
        deployTesterHelpers(m_runningDsm, m_modelNodeHelperRegistry, m_subSystemRegistry);
    ...
    @Test
    public void testCopyConfig3() throws ModelNodeInitException, EditConfigException, SAXException, IOException, ModelNodeFactoryException, SchemaBuildException {
    ...
    public void testCopyConfigDeletesRootListNotPresent() throws Exception {
        ...
        // Case when DS already has root nodes A & B, copy-config coming in with A & C; resulting C to be created & B to be dropped
        ...
        Element rootContainer = TestUtil.transformToElement("<config xmlns=\"http://www.test-company.com/solutions/anv-weather-app\">\n"
                + "<https-proxy>\n"
                ...
                + "</https-proxy>\n"
                + "</config>");
        Element rootList1 = TestUtil.transformToElement("<city xmlns=\"http://www.test-company.com/solutions/anv-weather-app\">\n"
                + "    <city-name>Bangalore</city-name>\n"
                + "    <country-name>India</country-name>\n"
                + "</city>");

        Element rootList2 = TestUtil.transformToElement("<city xmlns=\"http://www.test-company.com/solutions/anv-weather-app\">\n"
        ...
        // Copy-config coming in with config & root container; resulting root list to be deleted & root container to be created
    ...
    private void addSpyHelpers() {
        m_jukeBoxHelper = spy(new RootEntityContainerModelNodeHelper(m_jukeboxSchemaNode,
                m_modelNodeHelperRegistry, m_subSystemRegistry, m_schemaRegistry, m_runningDsm));
        m_runningAggregator.addModelServiceRootHelper(JukeboxConstants.JUKEBOX_SCHEMA_PATH, m_jukeBoxHelper);
        m_toasterHelper = spy(new RootEntityContainerModelNodeHelper(m_toasterSchemaNode,
                m_modelNodeHelperRegistry, m_subSystemRegistry, m_schemaRegistry, m_runningDsm));
        m_runningAggregator.addModelServiceRootHelper(ToasterConstants.TOASTER_SCHEMA_PATH, m_toasterHelper);
    }

    private void addWaRootHelpers() {
        ContainerSchemaNode configSchemaNode = (ContainerSchemaNode) m_schemaRegistry.getDataSchemaNode(WA_CONFIG_SCHEMAPATH);
        ...
        ContainerSchemaNode rootContainerSchemaNode = (ContainerSchemaNode) m_schemaRegistry.getDataSchemaNode(WA_ROOT_CONTAINER_SCHEMAPATH);
        ...
        ChildListHelper cityListHelper = new RootEntityListModelNodeHelper(citySchemaNode, m_modelNodeHelperRegistry, m_runningDsm,
    ...
    private void deployTesterHelpers(ModelNodeDataStoreManager dsm, ModelNodeHelperRegistry modelNodeHelperRegistry,
        ...
        SubSystem stateContainerSubSystem = new LocalSubSystem() {
            public Map<ModelNodeId, List<Element>> retrieveStateAttributes(Map<ModelNodeId, Pair<List<QName>, List<FilterNode>>> mapAttributes)
                ...
                for (java.util.Map.Entry<ModelNodeId, Pair<List<QName>, List<FilterNode>>> entry : mapAttributes.entrySet()) {
                    if (entry.getKey().xPathString().equals("/state-container")) {
                        ...
                        Element element = DocumentUtils.getElement(document, "person", childs, "http://netconfcentral.org/ns/tester", "testPrefix");
    ...
    private void setUpCandidateStore() throws ModelNodeInitException, ModelNodeFactoryException, SchemaBuildException {
        ...
        ContainerSchemaNode jukeboxSchemaNode = (ContainerSchemaNode) m_schemaRegistry.getDataSchemaNode(JukeboxConstants.JUKEBOX_SCHEMA_PATH);
        ...
        ContainerSchemaNode toasterSchemaNode = (ContainerSchemaNode) m_schemaRegistry.getDataSchemaNode(ToasterConstants.TOASTER_SCHEMA_PATH);
    ...
    private void copyConfig(Element sourceConfigElement, String target) {
        CopyConfigRequest request = new CopyConfigRequest().setSourceConfigElement(sourceConfigElement).setTarget(target, false);
        request.setMessageId("1");
        NetConfResponse response = new NetConfResponse().setMessageId("1");
