...
@Entity(name = "yangwithparentchildsameqname_root")
@Table(name = "yangwithparentchildsameqname_root")
@YangContainer(name="root", namespace = "urn:yang-with-parent-child-same-qname", revision= "2016-07-11")
public class Root {
    @Id
    @YangParentId
    String parentId;
