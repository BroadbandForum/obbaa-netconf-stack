...
public class YangAbsolutePathTest extends YangXmlSubtreeValidationTest {
    ...
    protected SchemaRegistry getSchemaRegistry() throws SchemaBuildException {
        ...
        schemaRegistry.registerAppAllowedAugmentedPath("datastore-validator-test",
                "/validation/someList/someInnerList/childContainer", mock(SchemaPath.class));
        schemaRegistry.registerAppAllowedAugmentedPath("datastore-validator-test",
                "/validation:validation/validation:someList/validation:someInnerList/validation:childContainer", mock
                        (SchemaPath.class));
