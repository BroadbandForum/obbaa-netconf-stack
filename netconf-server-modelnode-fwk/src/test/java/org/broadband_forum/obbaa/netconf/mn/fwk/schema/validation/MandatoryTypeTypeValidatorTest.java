...
public class MandatoryTypeTypeValidatorTest {
    ...
    public static final String MANDATORY_LEAF_ABSENT_IN_LIST_XML = "/yangSchemaValidationTest/mandatorytypevalidationtest/mandatoryLeafAbsentInList.xml";
    public static final String MANDATORY_LEAF_ABSENT_IN_SUBLIST_XML = "/yangSchemaValidationTest/mandatorytypevalidationtest/mandatoryLeafAbsentInSublist.xml";
    public static final String MANDATORY_CHOICE_ABSENT_IN_CONTAINER_XML = "/yangSchemaValidationTest/mandatorytypevalidationtest/mandatoryChoiceAbsentInContainer.xml";
    public static final String MANDATORY_CHOICE_PRESENT_WITH_INVALID_ELEMENT_IN_CONTAINER_XML = "/yangSchemaValidationTest/mandatorytypevalidationtest/mandatoryChoicePresentWithInvalidElementInContainer.xml";
    public static final String MANDATORY_CHOICE_PRESENT_IN_CONTAINER_XML = "/yangSchemaValidationTest/mandatorytypevalidationtest/mandatoryChoicePresentInContainer.xml";
    public static final String MANDATORY_CHOICE_ABSENT_IN_LIST_XML = "/yangSchemaValidationTest/mandatorytypevalidationtest/mandatoryChoiceAbsentInList.xml";
    public static final String MANDATORY_CHOICE_PRESENT_WITH_INVALID_ELEMENT_IN_LIST_XML = "/yangSchemaValidationTest/mandatorytypevalidationtest/mandatoryChoicePresentWithInvalidElementInList.xml";
    public static final String MANDATORY_CHOICE_PRESENT_IN_LIST_XML = "/yangSchemaValidationTest/mandatorytypevalidationtest/mandatoryChoicePresentInList.xml";
    public static final String MANDATORY_ANY_XML_ABSENT_IN_CONTAINER_XML = "/yangSchemaValidationTest/mandatorytypevalidationtest/mandatoryAnyXmlAbsentInContainer.xml";
    public static final String MANDATORY_ANY_XML_PRESENT_IN_CONTAINER_XML = "/yangSchemaValidationTest/mandatorytypevalidationtest/mandatoryAnyXmlPresentInContainer.xml";
    public static final String MANDATORY_ANY_XML_ABSENT_IN_LIST_XML = "/yangSchemaValidationTest/mandatorytypevalidationtest/mandatoryAnyXmlAbsentInList.xml";
    public static final String MANDATORY_ANY_XML_PRESENT_IN_LIST_XML = "/yangSchemaValidationTest/mandatorytypevalidationtest/mandatoryAnyXmlPresentInList.xml";
    public static final String CONTAINER_WITH_MANDATORY_LEAF_ABSENT_XML = "/yangSchemaValidationTest/mandatorytypevalidationtest/containerWithMandatoryLeafAbsent.xml";
    public static final String CONTAINER_WITH_MANDATORY_CHOICE_ABSENT_XML = "/yangSchemaValidationTest/mandatorytypevalidationtest/containerWithMandatoryChoiceAbsent.xml";
    public static final String CONTAINER_WITH_LEAF_IN_MANDATORY_CHOICE_ABSENT_XML = "/yangSchemaValidationTest/mandatorytypevalidationtest/containerWithLeafInMandatoryChoiceAbsent.xml";
    public static final String ALL_MANDATORY_ELEMENTS_PRESENT_XML = "/yangSchemaValidationTest/mandatorytypevalidationtest/allMandatoryElementsPresent.xml";
    ...
    public void testMandatoryLeafValidationInContainer() throws NetconfMessageBuilderException {
        ...
        try {
            ...
            assertEquals("name", rpcError.getErrorInfo().getElementsByTagName(NetconfRpcErrorInfo.MissingLeaf.value()).item(0).getTextContent());
    ...
    public void testMandatoryChoiceValidationInContainer() throws NetconfMessageBuilderException {
        ...
        try {
            ...
            assertEquals("play", rpcError.getErrorInfo().getElementsByTagName(NetconfRpcErrorInfo.MissingChoice.value()).item(0).getTextContent());
    ...
    public void testMandatoryLeafValidationInList() throws NetconfMessageBuilderException{
        ...
        try {
            ...
            assertEquals(NetconfRpcErrorTag.DATA_MISSING, rpcError.getErrorTag());
            assertTrue(rpcError.getErrorInfo().getElementsByTagName(NetconfRpcErrorInfo.MissingLeaf.value()) != null);
            assertEquals("year", rpcError.getErrorInfo().getElementsByTagName(NetconfRpcErrorInfo.MissingLeaf.value()).item(0).getTextContent());
            assertEquals("/jbox:jukebox/jbox:library/jbox:artist[jbox:name='Lenny']/jbox:album[jbox:name='Greatest hits']/jbox:year", rpcError.getErrorPath());
        }
    }
    ...
    public void testContainerWithMandatoryLeafAbsent() throws NetconfMessageBuilderException{
        ...
        try {
            ...
            assertTrue(rpcError.getErrorInfo().getElementsByTagName(NetconfRpcErrorInfo.MissingLeaf.value()) != null);
            assertEquals("name", rpcError.getErrorInfo().getElementsByTagName(NetconfRpcErrorInfo.MissingLeaf.value()).item(0).getTextContent());
            assertEquals("/jbox:jukebox/jbox:presence-container/jbox:non-presence-player-with-leaf/jbox:name", rpcError.getErrorPath());
        }
    }
    ...
    public void testContainerWithLeafInMandatoryChoiceAbsent() throws NetconfMessageBuilderException{
        ...
        try {
            ...
            assertEquals(NetconfRpcErrorTag.DATA_MISSING, rpcError.getErrorTag());
            assertTrue(rpcError.getErrorInfo().getElementsByTagName(NetconfRpcErrorInfo.MissingLeaf.value()) != null);
            assertEquals("creator", rpcError.getErrorInfo().getElementsByTagName(NetconfRpcErrorInfo.MissingLeaf.value()).item(0).getTextContent());
            assertEquals("/jbox:jukebox/jbox:presence-container/jbox:non-presence-player-with-choice/jbox:info/jbox:creator", rpcError.getErrorPath());
        }
    }
    ...
    public void testContainerWithMandatoryChoiceAbsent() throws NetconfMessageBuilderException{
        ...
        try {
            ...
            assertTrue(rpcError.getErrorInfo().getElementsByTagName(NetconfRpcErrorInfo.MissingLeaf.value()) != null);
            assertEquals("play", rpcError.getErrorInfo().getElementsByTagName(NetconfRpcErrorInfo.MissingChoice.value()).item(0).getTextContent());
            assertEquals("/jbox:jukebox/jbox:presence-container/jbox:non-presence-player-with-choice/jbox:play", rpcError.getErrorPath());
        }
    }
    ...
    public void testMandatoryChoiceValidationInList() throws NetconfMessageBuilderException {
        ...
        try {
            ...
            assertTrue(rpcError.getErrorInfo().getElementsByTagName(NetconfRpcErrorInfo.MissingChoice.value()) != null);
            assertEquals("play", rpcError.getErrorInfo().getElementsByTagName(NetconfRpcErrorInfo.MissingChoice.value()).item(0).getTextContent());
            assertEquals("/jbox:jukebox/jbox:library/jbox:artist[jbox:name='Lenny']/jbox:album[jbox:name='Greatest hits']/jbox:song[jbox:name='Are you gonne go my way']/jbox:play", rpcError.getErrorPath());
        }
    ...
    public void testMandatoryAnyXmlValidationInContainer() throws NetconfMessageBuilderException {
        ...
        try {
            ...
            assertEquals("extraInfo", rpcError.getErrorInfo().getElementsByTagName(NetconfRpcErrorInfo.MissingAnyxml.value()).item(0).getTextContent());
    ...
    public void testMandatoryAnyXmlValidationInList() throws NetconfMessageBuilderException {
        ...
        try {
            ...
            assertTrue(rpcError.getErrorInfo().getElementsByTagName(NetconfRpcErrorInfo.MissingAnyxml.value()) != null);
            assertEquals("extraInfo", rpcError.getErrorInfo().getElementsByTagName(NetconfRpcErrorInfo.MissingAnyxml.value()).item(0).getTextContent());
            assertEquals("/jbox:jukebox/jbox:library/jbox:artist[jbox:name='Lenny']/jbox:album[jbox:name='Greatest hits']/jbox:song[jbox:name='Are you gonne go my way']/jbox:extraInfo", rpcError.getErrorPath());
        }
