...
public class DefaultPasswordAuthenticationHandlerTest {
   ...
   @Test
    public void testAuthenticate(){
       ...
       assertFalse(m_apa.authenticate(new ClientAuthenticationInfo(1, "admin", "admin", null, null)).isAuthenticated());
       ...
       m_apa.setUsername("admin");
       m_apa.setPassword("admin");
       assertTrue(m_apa.authenticate(new ClientAuthenticationInfo(1, "admin", "admin", null, null)).isAuthenticated());
    }
    ...
    public void testAuthenticatePublicKey() throws Exception{
        ...
        String pubKeyStr = "MIIBuDCCASwGByqGSM44BAEwggEfAoGBAOg5MOEOL1Lwe8/38+illEM7LSnDbMbztQj/h7T0tgQixxebT6S2jcpLouZEYDOTDAuMb8UKhbxZ7+f+8xdTMhw4elpC/3LWs+WwncZM7LaxWtg66l74R4pp"
                + "WmIIsU1RaXOAgXoThNGr6IsDLaGiv7LQIbh8vzzMzl6lrlDjCcj7AhUAsty8KhNivqCqcCH/kbp+Aj+Vwj8CgYEAmytCjwTBuc84G/ibRV2J8QP0NDJ2VDRyJnkPjic4v/HCKbSL/nKjE2E2LlUC36mV"
                ...
                + "tOJPqxg3ZbttTI8Y1QWXabjPyY1c/YWdd/GasegQKrgMGM7ufGhWaNcllI0cC6o0J5K2zacGUufxSWeFZ9Unx2vCKYhIMKR66J+aHo5Wq9VF0UmsDKtoCGXFRVqVHFsM+6i8YfBD";
        ...
        assertTrue(handler.authenticate(pubKey).isAuthenticated());
        assertFalse(m_apa.authenticate(pubKey).isAuthenticated());
    }
