...
public class UnsignedIntegerTypeValidatorTest extends AbstractTypeValidatorTest {
    ...
    public void testUint8() throws NetconfMessageBuilderException {
        ...
        testFail("unsignedintegervalidator/invalid-uint8-1.xml",
                "The argument is out of bounds <min, 10> | The argument is out of bounds <20, 100> | The argument is " +
                        "out of bounds <120, max>",
                "/validation:validation/validation:type-validation[validation:id='1']/validation:uint8-type",
    ...
    public void testCustomUInt8() throws NetconfMessageBuilderException {
        ...
        testCustomFail(formRequestString(invalidCustomReq1),
                "range constraint error-app-message | range constraint error-app-message | range constraint " +
                        "error-app-message",
                "/validation:validation/validation:type-validation[validation:id='1']/validation:custom-uint8-type",
    ...
    public void testUint16() throws NetconfMessageBuilderException {
        ...
        testFail("unsignedintegervalidator/invalid-uint16-1.xml",
                ...
                "/validation:validation/validation:type-validation[validation:id='1']/validation:uint16-type",
        ...
        testFail("unsignedintegervalidator/invalid-uint16-6.xml",
                "The argument is out of bounds <10, 10000>",
                "/validation:validation/validation:type-validation[validation:id='1']/validation:uint16-type-ref",
                "range-out-of-specified-bounds");
    ...
    public void testCustomUInt16() throws NetconfMessageBuilderException {
        ...
        testCustomFail(formRequestString(invalidCustomReq1),
                ...
                "/validation:validation/validation:type-validation[validation:id='1']/validation:custom-uint16-type",
    ...
    public void testUint32() throws NetconfMessageBuilderException {
        ...
        testFail("unsignedintegervalidator/invalid-uint32-1.xml",
                "The argument is out of bounds <0, 4294967295>",
                "/validation:validation/validation:type-validation[validation:id='1']/validation:uint32-type",
                "range-out-of-specified-bounds");
        ...
        testFail("unsignedintegervalidator/invalid-uint32-4.xml",
                "The argument is out of bounds <0, 4294967295>",
                "/validation:validation/validation:type-validation[validation:id='1']/validation:uint32-type-ref",
                "range-out-of-specified-bounds");
