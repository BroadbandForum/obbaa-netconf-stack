...
public class YangEditConfigOperationAttributeTest extends AbstractYangValidationTestSetup {
    ...
    public static final String EDITCONFIGOPERATIONATTRIBUTETEST_YANG_FILE_YANG =
            "/editconfigoperationattributetest/yang-file.yang";
    public static final String AUGMENT_FILE = "/editconfigoperationattributetest/augment-default-example.yang";
    private static final String m_default_xmlFile = YangEditConfigCreateTest.class.getResource
            ("/editconfigoperationattributetest/default-file.xml").getPath();
    ...
    private void createServer(SubSystem subSystem) throws ModelNodeInitException, SchemaBuildException {
        ...
        m_schemaRegistry.loadSchemaContext("yang", Arrays.asList(TestUtil.getByteSource
                (EDITCONFIGOPERATIONATTRIBUTETEST_YANG_FILE_YANG), TestUtil.getByteSource(AUGMENT_FILE)), null,
                Collections.emptyMap());
        m_modelNodeWithAttributes = (ModelNodeWithAttributes) createInMemoryModelNode(Arrays.asList
                        (EDITCONFIGOPERATIONATTRIBUTETEST_YANG_FILE_YANG, AUGMENT_FILE), subSystem,
        ...
        m_rootModelNodeAggregator = new RootModelNodeAggregatorImpl(m_schemaRegistry, m_modelNodeHelperRegistry,
                m_modelNodeDsm, m_subSystemRegistry).addModelServiceRoot(m_componentId, m_modelNodeWithAttributes);
    ...
    public void testCreate() throws SAXException, IOException {
        NetConfResponse response = sendEditConfig(m_server, m_clientInfo, loadAsXml
                ("/editconfigoperationattributetest/edit-config-create-a-create-b-request.xml"), "1");
        assertXMLEquals("/ok-response.xml", response);
        verifyGetConfig(m_server, StandardDataStores.RUNNING, null,
                "/editconfigoperationattributetest/get-config-result1.xml", "1");

        response = sendEditConfig(m_server, m_clientInfo, loadAsXml
                ("/editconfigoperationattributetest/edit-config-create-a-create-b-request.xml"), "1");
        ...
        response = sendEditConfig(m_server, m_clientInfo, loadAsXml
                ("/editconfigoperationattributetest/edit-config-create-withoutnamespace-a-create-b-request.xml"), "1");
        assertXMLEquals("/editconfigoperationattributetest/edit-config-error-response-2.xml", response);
        verifyGetConfig(m_server, StandardDataStores.RUNNING, null,
                "/editconfigoperationattributetest/get-config-result1.xml", "1");

        response = sendEditConfig(m_server, m_clientInfo, loadAsXml
                ("/editconfigoperationattributetest/edit-config-create-withoutnamespace-a-create-withoutnamespace-b" +
                        "-request.xml"), "1");
        assertXMLEquals("/ok-response.xml", response);
        verifyGetConfig(m_server, StandardDataStores.RUNNING, null,
                "/editconfigoperationattributetest/get-config-result1.xml", "1");
        ...
        response = sendEditConfig(m_server, m_clientInfo, loadAsXml
                ("/editconfigoperationattributetest/edit-config-replace-withoutnamespace-a-replace-b-request.xml"),
                "1");
        assertXMLEquals("/ok-response.xml", response);
        verifyGetConfig(m_server, StandardDataStores.RUNNING, null,
                "/editconfigoperationattributetest/get-config-result2.xml", "1");

        response = sendEditConfig(m_server, m_clientInfo, loadAsXml
                ("/editconfigoperationattributetest/edit-config-replace-a-replace-b-request.xml"), "1");
        assertXMLEquals("/ok-response.xml", response);
        verifyGetConfig(m_server, StandardDataStores.RUNNING, null,
                "/editconfigoperationattributetest/get-config-result1.xml", "1");

        response = sendEditConfig(m_server, m_clientInfo, loadAsXml
                ("/editconfigoperationattributetest/edit-config-merge-a-delete-withoutnamespace-b-request.xml"), "1");
        assertXMLEquals("/ok-response.xml", response);
        verifyGetConfig(m_server, StandardDataStores.RUNNING, null,
                "/editconfigoperationattributetest/get-config-result1.xml", "1");

        response = sendEditConfig(m_server, m_clientInfo, loadAsXml
                ("/editconfigoperationattributetest/edit-config-merge-a-delete-b-request.xml"), "1");
        assertXMLEquals("/ok-response.xml", response);
        verifyGetConfig(m_server, StandardDataStores.RUNNING, null,
                "/editconfigoperationattributetest/get-config-result3.xml", "1");

        response = sendEditConfig(m_server, m_clientInfo, loadAsXml
                ("/editconfigoperationattributetest/edit-config-create-c-request.xml"), "1");
        assertXMLEquals("/ok-response.xml", response);
        verifyGetConfig(m_server, StandardDataStores.RUNNING, null,
                "/editconfigoperationattributetest/get-config-result4.xml", "1");
