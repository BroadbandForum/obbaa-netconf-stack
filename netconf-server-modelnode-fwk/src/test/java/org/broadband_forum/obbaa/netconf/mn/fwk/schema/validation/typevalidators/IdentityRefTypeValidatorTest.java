...
public class IdentityRefTypeValidatorTest extends AbstractTypeValidatorTest {
    ...
    public void testInvalidIdentityRef() throws NetconfMessageBuilderException {
        testFail("identityrefvalidator/invalid-identityref-1.xml", "Value \"yang1:english\" is not a valid " +
                        "identityref value.",
                "/validation:validation/validation:type-validation[validation:id='1']/validation:identityref-type",
                null);

        testFail("identityrefvalidator/invalid-identityref-2.xml", "Value \"yang1:english\" is not a valid " +
                        "identityref value.",
                "/validation:validation/validation:type-validation[validation:id='1']/validation:identityref-type",
                null);

        testFail("identityrefvalidator/invalid-identityref-3.xml", "Value \"yang:french\" is not a valid identityref " +
                        "value.",
                "/validation:validation/validation:type-validation[validation:id='1']/validation:identityref-type",
                null);

        testFail("identityrefvalidator/invalid-identityref-4.xml", "Value \"yang:french\" is not a valid identityref " +
                        "value.",
                "/validation:validation/validation:type-validation[validation:id='1']/validation:identityref-type",
                null);

        testFail("identityrefvalidator/invalid-identityref-5.xml", "Value \"english\" is not a valid identityref " +
                        "value.",
                "/validation:validation/validation:type-validation[validation:id='1']/validation:identityref-type",
                null);
