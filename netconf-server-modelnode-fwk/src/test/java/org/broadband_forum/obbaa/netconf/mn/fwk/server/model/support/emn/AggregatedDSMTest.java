...
public class AggregatedDSMTest {
    ...
    public void testDSMDelegationCreateNode() throws DataStoreException {
        ...
        m_aggregatedDSM.createNode(null, EMPTY_NODE_ID);
    }
    ...
    public void testDSMDelegationUpdateNode() throws DataStoreException {
        ...
        m_aggregatedDSM.updateNode(null, EMPTY_NODE_ID,null, null, false);
    }
    ...
    public void testDSMDelegationRemoveNode() throws DataStoreException {
        ...
        m_aggregatedDSM.removeNode(null, EMPTY_NODE_ID);
    }
    ...
    public void testDSMDelegationRemoveAllNodes() throws DataStoreException {
        ...
        m_aggregatedDSM.removeAllNodes(null, LIBRARY_SCHEMA_PATH, EMPTY_NODE_ID);
        
        m_aggregatedDSM.removeAllNodes(null, null, EMPTY_NODE_ID);
    }
    ...
    public void testCreateNode(){
    	m_aggregatedDSM.createNode(m_jukeboxModelNode, EMPTY_NODE_ID, 0);
    	
    	m_aggregatedDSM.createNode(null, EMPTY_NODE_ID, 0);
    }
    
    @Test
    public void testUpdateNode(){
    	m_aggregatedDSM.updateNode(m_jukeboxModelNode, EMPTY_NODE_ID, null, null, 0, true);
    	
    	m_aggregatedDSM.updateNode(null, EMPTY_NODE_ID, null, null, 0, true);
    }
    ...
    public void testFindNodes_CacheHasEmptyList(){
        ...
        when(m_schemaRegistry.getDataSchemaNode(ALBUM_SCHEMA_PATH)).thenReturn(albumSchemaNode);
        ModelNodeWithAttributes albumModelNode = new ModelNodeWithAttributes(ALBUM_SCHEMA_PATH,parentId,null,null,m_schemaRegistry,null);
