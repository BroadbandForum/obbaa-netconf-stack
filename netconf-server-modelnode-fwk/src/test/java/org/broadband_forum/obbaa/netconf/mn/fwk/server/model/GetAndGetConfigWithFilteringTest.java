...
public class GetAndGetConfigWithFilteringTest {
    ...
    public void initServer() throws SchemaBuildException, ModelNodeInitException, GetAttributeException {
        ...
        mockStateAttributes();
        ModelNodeWithAttributes jukeBoxWithYang = YangUtils.createInMemoryModelNode(yangFilePath, m_subSystem,
                m_modelNodeHelperRegistry,
    ...
    public void testGetConfigFilterTwoMatchNodes() throws SAXException, IOException {
        verifyGetConfig("/getandgetconfigwithfilteringtest/filter-two-matching.xml",
                "/getandgetconfigwithfilteringtest/getconfig-response-two-match.xml");
    }
    ...
    public void testGetConfigMultipleNodes() throws SAXException, IOException {
        verifyGetConfig("/filter-multiple-nodes.xml",
                "/getandgetconfigwithfilteringtest/getconfig-response-multiple-nodes_1.xml");
    }
    ...
    public void testGetConfigMultipleNodesAndSelect() throws SAXException, IOException {
        verifyGetConfig("/filter-multiple-nodes-with-select.xml",
                "/getandgetconfigwithfilteringtest/getconfig-response-multiple-nodes-with-select.xml");
    }
    ...
    private void populateStateValues(Map<ModelNodeId, Pair<List<QName>, List<FilterNode>>> stateAttributes,
                                     Map<ModelNodeId, List<Element>> stateAttributesValues) {
