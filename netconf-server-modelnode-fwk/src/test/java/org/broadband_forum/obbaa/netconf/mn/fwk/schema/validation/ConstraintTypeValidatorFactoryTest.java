...
public class ConstraintTypeValidatorFactoryTest {
    ...
    public void testFactoryMethod(){
        ...
        SchemaNodeConstraintParser schemaNodeConstraintParser = m_factory.getConstraintNodeValidator(dataSchemaNode, schemaRegistry, expValidator);
        ...
        verify(schemaRegistry).getSchemaNodeConstraintParser(dataSchemaNode);
        verify(schemaRegistry).putSchemaNodeConstraintParser(dataSchemaNode, schemaNodeConstraintParser); 
