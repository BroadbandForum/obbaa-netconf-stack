...
public class LockTest {
    ...
    public void initServer() throws SchemaBuildException {
        ...
        RootModelNodeAggregator rootModelNodeAggregator = new RootModelNodeAggregatorImpl(m_schemaRegistry,
                ...
                createEmptyJukeBox(m_modelNodeHelperRegistry, m_subSystemRegistry, m_schemaRegistry));
    ...
    public void testLockUnlockWithEditConfig() {
        ...
        EditConfigRequest editRequest = new EditConfigRequest().setTargetRunning().setTestOption
                (EditConfigTestOptions.SET)
