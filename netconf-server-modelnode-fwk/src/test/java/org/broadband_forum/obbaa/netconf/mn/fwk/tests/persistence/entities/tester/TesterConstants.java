...
public class TesterConstants {
    ...
    public static final SchemaPath STATE_ROOT_SCHEMA_PATH = SchemaPath.create(true, QName.create(TESTER_NS,
            TESTER_REVISION, TESTER_LOCAL_NAME));

    public static final SchemaPath STATE_CONTAINER_SCHEMA_PATH = SchemaPath.create(true, QName.create(TESTER_NS,
            TESTER_REVISION, "state-container"));
