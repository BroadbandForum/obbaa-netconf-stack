...
public class GetWithStateContainerTest {
    ...
    public void setUp() throws SchemaBuildException, ModelNodeInitException {
        ...
        m_jukeBoxModelNode = YangUtils.createInMemoryModelNode(yangFilePath, mock(DsmJukeboxSubsystem.class), m_modelNodeHelperRegistry,
    ...
    @Test
    public void testGetStateContainerSubtree() throws IOException, SAXException {

        verifyGet(m_server, "/getwithstatecontainertest/get-with-filter-admins-selectnode.xml","/getwithstatecontainertest/get-with-filter-admins-response.xml", MESSAGE_ID);
        verifyGet(m_server, "/getwithstatecontainertest/get-with-filter-admin-selectnode.xml","/getwithstatecontainertest/get-with-filter-admins-response.xml", MESSAGE_ID);
        verifyGet(m_server, "/getwithstatecontainertest/get-with-filter-admin-matchnode.xml","/getwithstatecontainertest/get-with-filter-admin-matchnode-response.xml", MESSAGE_ID);
        verifyGet(m_server, "/getwithstatecontainertest/get-with-filter-admin-2-matchnodes.xml","/getwithstatecontainertest/get-with-filter-admin-2-matchnodes-response.xml", MESSAGE_ID);
    ...
    private void registerSubSystems() {
        ...
        m_subSystemRegistry.register(MODULE_NAME,SPONSORS_SCHEMA_PATH,adminSubSystem);
        m_subSystemRegistry.register(MODULE_NAME,SPONSOR_SCHEMA_PATH,adminSubSystem);
        m_subSystemRegistry.register(MODULE_NAME,NAME_SCHEMA_PATH,adminSubSystem);
        m_subSystemRegistry.register(MODULE_NAME,TYPE_SCHEMA_PATH,adminSubSystem);
    }
}
