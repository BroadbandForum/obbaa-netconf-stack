...
public class XmlContainerModelNodeHelperTest {
    ...
    public void setUp() throws AnnotationAnalysisException, DataStoreException {
        ...
        when(m_dataStoreManager.createNode(new ModelNodeWithAttributes(LIBRARY_SCHEMA_PATH, m_jukeboxNodeId,
                m_modelNodeHelperRegistry, null, m_schemaRegistry, m_dataStoreManager), EMPTY_NODE_ID)).thenReturn
                (null);
        ...
        m_xmlContainerModelNodeHelper = new XmlContainerModelNodeHelper(m_containerSchemaNode, m_dataStoreManager,
                m_schemaRegistry);
    }
    ...
    public void testCreateChild() throws ModelNodeCreateException, DataStoreException {
        ...
        ModelNodeWithAttributes parentNode = new ModelNodeWithAttributes(JUKEBOX_SCHEMA_PATH, EMPTY_NODE_ID,
                m_modelNodeHelperRegistry, null, m_schemaRegistry, m_dataStoreManager);
        ModelNode newNode = m_xmlContainerModelNodeHelper.createChild(parentNode, new HashMap<QName,
                ConfigLeafAttribute>());
        ...
        parentNode = new XmlModelNodeImpl(JUKEBOX_SCHEMA_PATH, Collections.EMPTY_MAP, Collections.EMPTY_LIST, null,
                EMPTY_NODE_ID, null, m_modelNodeHelperRegistry, m_schemaRegistry, null, m_dataStoreManager);
        when(m_dataStoreManager.findNode((SchemaPath) Matchers.anyObject(), (ModelNodeKey) Matchers.anyObject(),
                (ModelNodeId) Matchers.anyObject())).thenReturn(parentNode);
