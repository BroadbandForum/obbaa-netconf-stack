...
public class YangListTest extends AbstractYangValidationTestSetup {
    ...
    private void setDataStoreAndModel(String datastore, String dataXmlPath) throws ModelNodeInitException,
        ...
        DsmJukeboxSubsystem subSystem = new DsmJukeboxSubsystem(m_modelNodeDsm, "http://example" +
    ...
    public void testEditConfigCreateOrderedByUser() throws ModelNodeInitException, SAXException, IOException,
        ...
        NetConfResponse response = sendEditConfig(m_server, m_clientInfo, loadAsXml
                (LIST_EDITCONFIG_CREATE_ORDERED_BY_USER_REQUEST_XML), "1");
    ...
    public void testEditConfigMergeOrderedByUser() throws ModelNodeInitException, SAXException, IOException,
        ...
        NetConfResponse response = sendEditConfig(m_server, m_clientInfo, loadAsXml
                (LIST_EDITCONFIG_MERGE_ORDERED_BY_USER_REQUEST_XML), "1");
    ...
    public void testEditConfigReplaceOrderedByUser() throws ModelNodeInitException, SAXException, IOException,
        ...
        NetConfResponse response = sendEditConfig(m_server, m_clientInfo, loadAsXml
                (LIST_EDITCONFIG_REPLACE_ORDERED_BY_USER_REQUEST_XML), "1");
