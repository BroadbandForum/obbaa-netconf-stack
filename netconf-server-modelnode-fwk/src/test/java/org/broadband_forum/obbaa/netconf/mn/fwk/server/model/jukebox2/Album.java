...
public class Album extends AnnotationModelNode {
    ...
    public Album(ModelNode parent, ModelNodeId parentNodeId, ModelNodeHelperRegistry helperRegistry,
    ...
    @ContainerList(name = "song", namespace = Jukebox.NAMESPACE, childClass = Song.class, childFactoryName =
    ...
    public Album addSong(String name) {
        Song song = null;
        song = new Song(this, new ModelNodeId(getModelNodeId()), getModelNodeHelperRegistry(), getSubSystemRegistry()
                , getSchemaRegistry());
        song.setName(name);
        m_songs.add(song);
        return this;
