...
@Entity(name = "jukeboxwithconfigattr_albumOrderedByUser")
@Table(name = "jukeboxwithconfigattr_albumOrderedByUser")
@IdClass(AlbumPK.class)
@YangList(name="album-ordered-by-user", namespace = JukeboxConstants.JB_NS, revision=JukeboxConstants.JB_REVISION)
public class AlbumOrderedByUser {
