...
public class ModelNodeDynaBeanTest {
    ...
    public void initServer() throws SchemaBuildException, ModelNodeInitException {
        ...
        m_jukeboxModelNode = YangUtils.createInMemoryModelNode(YANG_MODEL_PATH, new LocalSubSystem(),
                m_modelNodeHelperRegistry,
                m_subSystemRegistry, m_schemaRegistry, m_dataStoreManager);
        m_runningRootModelNodeAggregator = new RootModelNodeAggregatorImpl(m_schemaRegistry,
                m_modelNodeHelperRegistry, m_dataStoreManager, m_subSystemRegistry).addModelServiceRoot(COMPONENT_ID,
                m_jukeboxModelNode);
    ...
    public void testDynaBean() throws ModelNodeInitException {
        ...
        Object libraryObj = jukeboxBean.get("library");
