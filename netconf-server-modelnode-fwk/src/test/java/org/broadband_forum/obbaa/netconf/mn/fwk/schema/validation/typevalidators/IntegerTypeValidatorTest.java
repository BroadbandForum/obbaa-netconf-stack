...
public class IntegerTypeValidatorTest extends AbstractTypeValidatorTest {
    ...
    public void testInt8() throws NetconfMessageBuilderException {
        ...
        testFail("integervalidator/invalid-int8-1.xml",
                "The argument is out of bounds <min, 0> | The argument is out of bounds <10, 100> | The argument is " +
                        "out of bounds <120, max>",
                "/validation:validation/validation:type-validation[validation:id='1']/validation:int8-type",
                "range-out-of-specified-bounds | range-out-of-specified-bounds | range-out-of-specified-bounds");
    ...
    public void testCustomInt8() throws NetconfMessageBuilderException {
        ...
        testCustomFail(formRequestString(invalidCustomReq1),
                "range constraint error-app-message | range constraint error-app-message | range constraint " +
                        "error-app-message",
                "/validation:validation/validation:type-validation[validation:id='1']/validation:custom-int8-type",
                "range constraint error-app-tag | range constraint error-app-tag | range constraint error-app-tag");
    }
    ...
    public void testInt16() throws NetconfMessageBuilderException {
        ...
        testFail("integervalidator/invalid-int16-1.xml",
                ...
                "/validation:validation/validation:type-validation[validation:id='1']/validation:int16-type",
        ...
        testFail("integervalidator/invalid-int16-6.xml",
                "The argument is out of bounds <10, 1000>",
                "/validation:validation/validation:type-validation[validation:id='1']/validation:int16-type-ref",
                "range-out-of-specified-bounds");
    ...
    public void testCustomInt16() throws NetconfMessageBuilderException {
        ...
        testCustomFail(formRequestString(invalidCustomReq1),
                ...
                "/validation:validation/validation:type-validation[validation:id='1']/validation:custom-int16-type",
                "range constraint error-app-tag");
    }
    ...
    public void testInt32() throws NetconfMessageBuilderException {
        ...
        testFail("integervalidator/invalid-int32-1.xml",
                "The argument is out of bounds <-2147483648, 2147483647>",
                "/validation:validation/validation:type-validation[validation:id='1']/validation:int32-type",
                "range-out-of-specified-bounds");
        ...
        testFail("integervalidator/invalid-int32-4.xml",
                "The argument is out of bounds <-2147483648, 2147483647>",
                "/validation:validation/validation:type-validation[validation:id='1']/validation:int32-type-ref",
                "range-out-of-specified-bounds");
