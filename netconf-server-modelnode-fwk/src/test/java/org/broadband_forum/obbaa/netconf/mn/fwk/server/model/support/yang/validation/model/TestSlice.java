...
@YangList(name = "test-slice", namespace = VALIDATION_NS, revision = VALIDATION_REVISION)
@Entity
@IdClass(value = TestSlicePK.class)
public class TestSlice implements Serializable {

	private static final long serialVersionUID = 148705841196341480L;
	...
	public String toString() {
		return "TestSlice [nameKey=" + nameKey + ", parentId=" + parentId + ", schemaPath=" + schemaPath + "]";
	}
}
