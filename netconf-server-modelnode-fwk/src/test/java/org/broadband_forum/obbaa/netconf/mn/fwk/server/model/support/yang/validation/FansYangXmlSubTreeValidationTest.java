...
public class FansYangXmlSubTreeValidationTest extends AbstractRootModelTest {
    ...
    public void testDeleteListWithSlice() throws Exception {
        ...
        assertEquals("Instance required with value - vno1", ncResponse.getErrors().get(0).getErrorMessage());
        assertEquals(
                "/validation:validation/validation:someList[validation:someKey=TestFANS]/validation:someInnerList" +
                        "[validation:someKey=OLT1.ONT1]/fanstest:test-slicing/fanstest:test-slice[fanstest:virtual" +
                        "-device-id=virtualID]/fanstest:vno",
