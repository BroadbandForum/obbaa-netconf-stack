...
public class YangEditConfigCreateDefaultTest extends AbstractYangValidationTestSetup {
    ...
    private static final String m_default_xmlFile = YangEditConfigCreateTest.class.getResource
            ("/defaultcapability/default-file.xml").getPath();
    ...
    public void initServer() throws SchemaBuildException, ModelNodeInitException, ModelNodeFactoryException {
        m_schemaRegistry = new SchemaRegistryImpl(Arrays.asList(TestUtil.getByteSource
                (DEFAULTCAPABILITY_YANG_FILE_YANG), TestUtil.getByteSource(AUGMENTED_WHEN_CONDITION_YANG)), new
                NoLockService());
    ...
    private void createNonEmptyServer(SubSystem subSystem) throws ModelNodeInitException, ModelNodeFactoryException {
        ...
        m_model = (ModelNodeWithAttributes) YangUtils.createInMemoryModelNode(Arrays.asList
                (DEFAULTCAPABILITY_YANG_FILE_YANG, AUGMENTED_WHEN_CONDITION_YANG), subSystem,
                m_modelNodeHelperRegistry, m_subSystemRegistry, m_schemaRegistry, modelNodeDsm);
        m_rootModelNodeAggregator = new RootModelNodeAggregatorImpl(m_schemaRegistry, m_modelNodeHelperRegistry,
                modelNodeDsm, m_subSystemRegistry).addModelServiceRoot(m_componentId, m_model);
    ...
    public void testCreate() throws Exception {
        NetConfResponse response = sendEditConfig(m_server, m_clientInfo, loadAsXml
                ("/defaultcapability/edit-config-create-request.xml"), "1");
    ...
    public void testCreateWithWhenCondition() throws Exception {
        ...
        assertXMLEquals("/ok-response.xml", response);
        verifyGetConfig(m_server, StandardDataStores.RUNNING, null, "/defaultcapability/get-config-withWhen-result" +
                ".xml", "1");
    }
    ...
    public void testReplace() throws Exception {
        NetConfResponse response = sendEditConfig(m_server, m_clientInfo, loadAsXml
                ("/defaultcapability/edit-config-replace-request.xml"), "1");
    ...
    public void testMerge() throws Exception {
        NetConfResponse response = sendEditConfig(m_server, m_clientInfo, loadAsXml
                ("/defaultcapability/edit-config-merge-request.xml"), "1");
