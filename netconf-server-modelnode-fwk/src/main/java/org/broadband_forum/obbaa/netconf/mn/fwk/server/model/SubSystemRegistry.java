...
public interface SubSystemRegistry extends WrappedService<SubSystemRegistry> {
	...
	CompositeSubSystem getCompositeSubSystem();

	void setCompositeSubSystem(CompositeSubSystem compositeSubSystem);
