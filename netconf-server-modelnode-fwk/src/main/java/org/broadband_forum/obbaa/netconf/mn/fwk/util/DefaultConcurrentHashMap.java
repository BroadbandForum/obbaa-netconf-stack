                ...
                if (m_defaultValue != null) {
                    if (m_createSynchronizedCollection) {
                        if (m_defaultValue instanceof Map) {
                            returnValue = (V) Collections.synchronizedMap((Map<?, ?>) m_defaultValue.getClass()
                                    .newInstance());
                        } else if (m_defaultValue instanceof Set) {
                            returnValue = (V) Collections.synchronizedSet((Set<?>) m_defaultValue.getClass()
                                    .newInstance());
                        } else if (m_defaultValue instanceof List) {
                            returnValue = (V) Collections.synchronizedList((List<?>) m_defaultValue.getClass()
                                    .newInstance());
                        } else if (m_defaultValue instanceof Collection) {
                            returnValue = (V) Collections.synchronizedCollection((Collection<?>) m_defaultValue
