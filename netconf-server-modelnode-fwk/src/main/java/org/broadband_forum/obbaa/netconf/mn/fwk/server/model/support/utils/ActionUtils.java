...
public class ActionUtils {
	...
	public static DataSchemaNode getActionInputChildNode(ActionDefinition actionDef, QName qname) {
		if (actionDef != null) {
			DataNodeContainer node = actionDef.getInput();
			return node.findDataChildByName(qname).orElse(null);
		}
		return null;
	}
}
