...
public class StaticSchemaRegistryDeployer extends ModelServiceDeployerImpl {
    ...
    private static final AdvancedLogger LOGGER = LoggerFactory.getLogger(StaticSchemaRegistryDeployer.class,
            "netconf-stack", "DEBUG", "GLOBAL");

    public StaticSchemaRegistryDeployer(ModelNodeDSMRegistry modelNodeDSMRegistry, ModelNodeHelperRegistry
            modelNodeHelperRegistry, SubSystemRegistry subSystemRegistry, RpcRequestHandlerRegistry
            rpcRequestHandlerRegistry, ModelNodeHelperDeployer modelNodeHelperDeployer, SchemaRegistry
            schemaRegistry, ReadWriteLockService lockService) {
        super(modelNodeDSMRegistry, modelNodeHelperRegistry, subSystemRegistry, rpcRequestHandlerRegistry,
                modelNodeHelperDeployer,
