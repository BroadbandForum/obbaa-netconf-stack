...
public class TestTxUtils {
    ...
    public static <T extends ModelNodeDataStoreManager> T getTxDecoratedDSM(final PersistenceManagerUtil
                                                                                        persistenceManagerUtil, final
                ...
                new Class[]{ModelNodeDataStoreManager.class}, new InvocationHandler() {
                    ...
                    public Object invoke(Object o, Method method, Object[] args) throws Throwable {
                        ...
                        if (persistenceManagerUtil.getEntityDataStoreManager() != null &&
                                ...
                                persistenceManagerUtil.getEntityDataStoreManager().getEntityManager().getTransaction
                                        () != null &&
                                persistenceManagerUtil.getEntityDataStoreManager().getEntityManager().getTransaction
                                        ().isActive()) {
