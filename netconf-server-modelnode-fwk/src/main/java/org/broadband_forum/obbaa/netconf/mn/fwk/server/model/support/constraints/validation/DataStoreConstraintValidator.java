...
public interface DataStoreConstraintValidator {
	 ...
	 */
	void validate(ModelNode modelNode, DSValidationContext validationContext) throws ValidationException;
	void validateLeafRef(ModelNode modelNode, DSValidationContext validationContext) throws ValidationException;
}
