...
public class NoopConstraintParser implements TypeValidator {

    public NoopConstraintParser() {
    }

    @Override
    public void validate(Element value, boolean validateInsertAttribute, String insertValue)
