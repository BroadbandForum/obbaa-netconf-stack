...
public class StringToObjectTransformer {
    ...
    private static BigInteger transformToBigInteger(String strValue) throws TransformerException {
        try {
            ...
            NetconfRpcError rpcError = buildNetconfRpcError("Invalid value : " + strValue + ", it should be a " +
                    "BigInteger");
    ...
    private static Byte transformToByte(String strValue) throws TransformerException {
        try {
            ...
            NetconfRpcError rpcError = buildNetconfRpcError("Invalid value : " + strValue + ", it should be a Byte " +
                    "with range from " + Byte.MIN_VALUE + " to " + Byte.MAX_VALUE);
            throw new TransformerException(rpcError);
        }
    }
    ...
    private static Short transformToShort(String strValue) throws TransformerException {
        try {
            ...
            NetconfRpcError rpcError = buildNetconfRpcError("Invalid value : " + strValue + ", it should be a Short " +
                    "with range from " + Short.MIN_VALUE + " to " + Short.MAX_VALUE);
            throw new TransformerException(rpcError);
        }
    }
    ...
    private static Long transformToLong(String strValue) throws TransformerException {
        try {
            ...
            NetconfRpcError rpcError = buildNetconfRpcError("Invalid value : " + strValue + ", it should be a Long " +
                    "with range from " + Long.MIN_VALUE + " to " + Long.MAX_VALUE);
            throw new TransformerException(rpcError);
        }
    }
