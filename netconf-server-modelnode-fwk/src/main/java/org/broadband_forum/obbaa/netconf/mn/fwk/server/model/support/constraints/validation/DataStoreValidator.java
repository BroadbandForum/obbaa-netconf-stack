...
public interface DataStoreValidator {
    List<Notification> validate(RootModelNodeAggregator rootModelNodes, EditContainmentNode editTree,
                                EditConfigRequest request, NetconfClientInfo clientInfo) throws ValidationException;

    void validateMissingChildren(ModelNodeWithAttributes modelNode, Collection<SchemaPath> changeNodeSet) throws
