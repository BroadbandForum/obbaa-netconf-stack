...
public interface EntityRegistry {
    ...
    void addConfigAttributeGetters(Class klass, Map<QName, Method> configAttributeGetters, Map<QName, String>
            fieldNames);
    ...
    void updateRegistry(String componentId, List<Class> classes, SchemaRegistry schemaRegistry,
