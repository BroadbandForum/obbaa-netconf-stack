...
public class CompositeEditCommand implements Command{
    ...
    private static final AdvancedLogger ANV_GLOBAL_LOGGER = AdvancedLoggerUtil.getGlobalDebugLogger(CompositeEditCommand.class, LogAppNames.NETCONF_STACK);
	...
	public void execute() throws CommandExecutionException {
		...
		for(Command command : m_commands){
			try {
			    ...
			    ANV_GLOBAL_LOGGER.debug("Command execution failed, error option is : {} n {}", m_errorOption, e.toString());
