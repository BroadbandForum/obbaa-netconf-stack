 ...
 * 1. Serve NC Server with capabilities derived from static capabilities like base:1.0/base:1.1 and the list yang
 * modules currently loaded in the SchemaRegistry
 * 2. Allow caching of the capabilities there by reducing calls to SchemaRegistry. - TBD
 * The cache is kept upto date by listening to bundle deploy events and loading the capabilities everytime such an
 * event happens.
 * <p>
