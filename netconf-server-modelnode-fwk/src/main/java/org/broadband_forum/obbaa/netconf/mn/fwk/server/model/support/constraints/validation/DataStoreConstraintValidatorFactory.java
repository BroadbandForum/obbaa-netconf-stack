...
public class DataStoreConstraintValidatorFactory {
    ...
    private static final AdvancedLogger LOGGER = LoggerFactory.getLogger(DataStoreConstraintValidatorFactory.class,
    ...
    public DataStoreConstraintValidator getValidator(DataSchemaNode schemaNode, SchemaRegistry schemaRegistry,
                                                     ...
                                                     DSExpressionValidator expressionValidator) {
        if (schemaNode instanceof LeafSchemaNode) {
            return new LeafValidator(schemaRegistry, modelNodeHelperRegistry, (LeafSchemaNode) schemaNode,
                    expressionValidator);
        } else if (schemaNode instanceof LeafListSchemaNode) {
            return new LeafListValidator(schemaRegistry, modelNodeHelperRegistry, (LeafListSchemaNode) schemaNode,
                    expressionValidator);
        } else if (schemaNode instanceof ContainerSchemaNode) {
            return new ContainerValidator(schemaRegistry, modelNodeHelperRegistry, (ContainerSchemaNode) schemaNode,
                    expressionValidator);
        } else if (schemaNode instanceof ListSchemaNode) {
            return new ListValidator(schemaRegistry, modelNodeHelperRegistry, (ListSchemaNode) schemaNode,
                    expressionValidator);
        } else if (schemaNode instanceof AnyXmlSchemaNode) {
            return new AnyXmlDataStoreConstraintValidator(schemaRegistry, modelNodeHelperRegistry, (AnyXmlSchemaNode)
                    schemaNode);
        } else {
