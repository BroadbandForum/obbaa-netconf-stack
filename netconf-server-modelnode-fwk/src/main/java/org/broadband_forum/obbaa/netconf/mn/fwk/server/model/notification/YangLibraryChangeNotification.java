...
public class YangLibraryChangeNotification extends NetconfNotification {
	private static final AdvancedLogger LOGGER = AdvancedLoggerUtil.getGlobalDebugLogger(YangLibraryChangeNotification.class, LogAppNames.NETCONF_STACK);
    ...
    public Element buildYangLibraryChangeNotificationElement(String prefix, String moduleSetId) throws NetconfMessageBuilderException {
