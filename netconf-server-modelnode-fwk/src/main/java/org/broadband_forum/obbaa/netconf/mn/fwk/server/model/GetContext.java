...
public class GetContext extends GetConfigContext {
    ...
    public GetContext(NetconfClientInfo client, Document doc, FilterNode filter, StateAttributeGetContext getStateAttributeContext, ConfigAttributeGetContext configAttributeGetContext) {
        super(client, doc, filter, configAttributeGetContext);
