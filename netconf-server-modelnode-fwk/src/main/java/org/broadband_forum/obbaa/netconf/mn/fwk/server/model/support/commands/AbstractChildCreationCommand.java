...
public abstract class AbstractChildCreationCommand implements Command {
    ...
    public AbstractChildCreationCommand(EditContainmentNode editData, NotificationContext notificationContext, String
            errorOption,
                                        DefaultCapabilityCommandInterceptor interceptor, NetconfClientInfo
                                                clientInfo, EditContext parentEditContext) {
        m_editData = editData;
