...
public class SchemaAwareDOMEncryptVisitor extends SchemaAwareDOMVisitor {

    private boolean m_metadata = true;

    public SchemaAwareDOMEncryptVisitor(Element root, SchemaRegistry schemaRegistry) {
