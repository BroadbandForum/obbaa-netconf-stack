 ...
 * a. If there is a YangChild/YangAttribute/YangList, check if there is actually a yang child/yang attribute/yang
...
public class EntityValidator {
    ...
    public static final String INVALID_YANG_CHILD_MUST_VE_BEEN_A_LIST = "Invalid Yang child found, must've been a " +
            "list - ";
    ...
    private static void validateAnnotations(SchemaRegistry schemaRegistry, SchemaPath parentSchemaPath, Class klass,
                                            Map<Class, List<String>> errors) {
    ...
    private static void validateYangChild(SchemaRegistry schemaRegistry, SchemaPath schemaPath, Field field, Class
            klass, Map<Class, List<String>> errors) {
    ...
    private static void validateYangAttribute(SchemaRegistry schemaRegistry, SchemaPath parentSchemaPath, Field
            field, Class klass, Map<Class, List<String>> errors) {
    ...
    private static QName getQName(Class klass, Annotation[] declaredAnnotations, SchemaPath parentSchemaPath) {
        QName qName = EntityRegistryBuilder.getQName(klass.getName(), declaredAnnotations, parentSchemaPath
                .getLastComponent());
        return qName;
    }
