...
public interface MultiRpcRequestHandler {
     ...
     * <p>
     * Each MultiRpcHandler will have a namespace-head (a string) defined in the descriptor file which will be used
     * for comparison with the
     * rpc namespace in to order to check whether the particular rpc can be handled or not.
     * <p>
     * This method will return the initial substring (ie. namespace-head of the handler) of the rpc namespace on
     * which it matches.
     *
     * @param rpcName
     */
     ...
     * <p>
     * The MultiRpcRequestHandlers should implement this method and set {@link NetConfResponse#setOk(boolean)} method
     * of response
     * For failure cases, the MultiRpcRequestHandlers should add NetConfResponse errors to
