...
/**
 * This class is a Runtime exception to ease in DB rollback when a validation exception happens. Apache Aries honors
 * only
...
public class RpcValidationException extends RuntimeException {
    ...
    public RpcValidationException(String message, Throwable cause, NetconfRpcError rpcError, boolean
            enableSuppression, boolean writableStackTrace) {
        super(message, cause, enableSuppression, writableStackTrace);
        m_rpcError = rpcError;
    }

    public RpcValidationException(String message, Throwable cause, boolean enableSuppression, boolean
            writableStackTrace) {
        super(message, cause, enableSuppression, writableStackTrace);
    }
